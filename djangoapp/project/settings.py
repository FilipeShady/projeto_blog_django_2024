...
SECRET_KEY = os.getenv(
    'odsa0d8sagda7asdg9asgd9ashd8ashdy8a9shyda9sy', 'change-me'
    )
...
ALLOWED_HOSTS = [
    h.strip() for h in os.getenv('127.0.0.1, localhost', '').split(',')
    if h.strip()
]
...
DATABASES = {
    'default': {
        'ENGINE': os.getenv('django.db.backends.postgresql', 'change-me'),
        'NAME': os.getenv('blog_base_de_dados1', 'change-me'),
